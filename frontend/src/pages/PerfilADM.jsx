        ...
        <section className="mb-6 rounded-2xl bg-white shadow-md p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="text-base font-semibold">{isAdmin ? "Administrador(a)" : (user?.role || "user")}</div>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-2xl bg-white shadow-md p-5">
            ...
            <div className="flex gap-3 mt-4">
              <a href="/eventos/novo" className="rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-bold text-white">Novo evento</a>
              <a href="/eventos/novo?template=rapido" className="rounded-xl border-2 border-violet-600 px-4 py-2.5 text-sm font-bold text-violet-700">Modelo rápido</a>
            </div>
          </div>

          <div className="rounded-2xl bg-white shadow-md p-5">
            <h3 className="text-lg font-extrabold mb-1">Gerenciar eventos</h3>
            <p className="text-sm text-gray-600">Edite inscrições, presença e exporte relatórios.</p>
            <div className="flex gap-3 mt-4">
              <a href="/eventos" className="rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-bold text-white">Abrir lista</a>
              <button className="rounded-xl border-2 border-violet-600 px-4 py-2.5 text-sm font-bold text-violet-700"
